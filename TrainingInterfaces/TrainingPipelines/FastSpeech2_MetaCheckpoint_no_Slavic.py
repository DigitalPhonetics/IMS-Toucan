...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, find_faulty_samples_mode=False):
    ...
    base_dir = os.path.join("Models", "FastSpeech2_Meta_no_slav")
...
def train_loop(net,
    ...
    default_embeddings = {"en": None, "de": None, "el": None, "es": None, "fi": None, "hu": None, "nl": None, "fr": None}
    for index, lang in enumerate(["en", "de", "el", "es", "fi", "hu", "nl", "fr"]):
    ...
    for step in tqdm(range(step_counter, steps)):
        ...
        if step % steps_per_checkpoint == 0:
            ...
            for lang in ["en", "de", "el", "es", "fi", "hu", "nl", "fr"]:
