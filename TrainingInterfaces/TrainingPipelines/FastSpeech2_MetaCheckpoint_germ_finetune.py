...
def train_loop(net,
    ...
    default_embeddings = {"de": None, "el": None, "es": None, "fi": None, "ru": None, "hu": None, "nl": None, "fr": None}
    for index, lang in enumerate(["de", "el", "es", "fi", "ru", "hu", "nl", "fr"]):
    ...
    for step in tqdm(range(step_counter, steps)):
        ...
        if step % steps_per_checkpoint == 0:
            ...
            for lang in ["de", "el", "es", "fi", "ru", "hu", "nl", "fr"]:
