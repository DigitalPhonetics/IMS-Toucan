...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "EmoVDBSam_Embedding")
    os.makedirs(save_dir, exist_ok=True)

    datasets = list()

    train_set = datasets.append(prepare_fastspeech_corpus(transcript_dict=build_path_to_transcript_dict_emovdb_sam(),
