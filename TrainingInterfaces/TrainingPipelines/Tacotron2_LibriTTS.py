...
def run(gpu_id, resume_checkpoint, finetune, model_dir):
    ...
    model = Tacotron2(idim=166, odim=80, spk_embed_dim=960, use_dtw_loss=False, use_alignment_loss=False, atype='location')
    ...
    train_loop(net=model,
               ...
               steps=100000,
               batch_size=32,  # this works for a 24GB GPU. For a smaller GPU, consider decreasing batchsize.
               epochs_per_save=1,
