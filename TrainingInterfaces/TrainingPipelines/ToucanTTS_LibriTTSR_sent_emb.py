...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if not os.path.exists(os.path.join(PREPROCESSING_DIR, "librittsr", "sent_embs_emoBERTcls.pt")):
        ...
        torch.save(sent_embs, os.path.join(PREPROCESSING_DIR, "librittsr", "sent_embs_emoBERTcls.pt"))
        print(f'Saved sentence embeddings in {os.path.join(PREPROCESSING_DIR, "librittsr", "sent_embs_emoBERTcls.pt")}')
        ...
        sent_embs = torch.load(os.path.join(PREPROCESSING_DIR, "librittsr", "sent_embs_emoBERTcls.pt"), map_location='cpu')
