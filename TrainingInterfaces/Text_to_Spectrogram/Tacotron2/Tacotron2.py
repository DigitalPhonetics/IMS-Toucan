...
class Tacotron2(torch.nn.Module):
   ...
   """
    ...
    def __init__(
            ...
            dunits=1024,
            prenet_layers=2,
            prenet_units=64,  # default in the paper is 256, but can cause over-reliance on teacher forcing, so 64 sometimes recommended
            postnet_layers=5,
            postnet_chans=512,
            postnet_filts=5,
            ...
            guided_attn_loss_lambda=1.0,  # weight of the loss
