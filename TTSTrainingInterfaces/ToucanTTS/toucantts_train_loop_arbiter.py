...
def train_loop(net,  # an already initialized ToucanTTS model that should be trained.
               ...
               batch_size=18,  # how many samples to put into one batch. Higher batch size is more stable, but requires more VRAM. 42 is tested on a 48GB GPU
               ...
               steps=500000,  # how many updates to run until training is completed
