...
if __name__ == '__main__':
    ...
    train_set_css10de = MelGANDataset(list_of_paths=get_file_list_css10ge()[:-50],
                                      cache=os.path.join(melgan_cache_dir, "german_train.txt"))
    valid_set_css10de = MelGANDataset(list_of_paths=get_file_list_css10ge()[-50:],
    ...
    train_loop(batchsize=16,
               ...
               train_dataset=train_set_css10de,
               valid_dataset=valid_set_css10de,
