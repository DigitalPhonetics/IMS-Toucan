...
for file in tqdm(os.listdir("audios/evaluation/human")):
    if file.endswith(".wav"):
        mcd_lyric_cloned.append(soft_mcd(f"audios/evaluation/human/{file}",
                                         f"audios/evaluation/poetry_cloned/{file.split('.')[0]}_poetic_cloned.wav"))
        mcd_lyric_uncond.append(soft_mcd(f"audios/evaluation/human/{file}",
                                         f"audios/evaluation/poetry_unconditional/{file.split('.')[0]}_poetic_uncond.wav"))
        mcd_prose_cloned.append(soft_mcd(f"audios/evaluation/human/{file}",
                                         f"audios/evaluation/prosa_cloned/{file.split('.')[0]}_prosa_cloned.wav"))
        mcd_prose_uncond.append(soft_mcd(f"audios/evaluation/human/{file}",
