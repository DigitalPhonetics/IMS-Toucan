...
if __name__ == '__main__':
    print("Preparing")
    model_save_dir = "Models/MelGAN_Karlsson"
    ...
    train_set = MelGANDataset(list_of_paths=get_file_list_karlsson()[:-50],
                              cache=os.path.join(melgan_cache_dir, "karlsson_train.txt"))
    valid_set = MelGANDataset(list_of_paths=get_file_list_karlsson()[-50:],
                              cache=os.path.join(melgan_cache_dir, "karlsson_valid.txt"))
