...
directory *Models* in the top-level of your clone. In there, create a directory called *SpeakerEmbedding*. In this directory
you put the two files *wav2mel.pt* and
