...
if __name__ == '__main__':
    ...
    tf.string_to_tensor("Alles klar, jetzt. testen wir einen deutschen Satz. Ich hoffe es gibt nicht mehr viele unspezifizierte Phoneme. Unter unter uns, fuhr, uhr?", view=True)
