...
class ArticulatoryCombinedTextFrontend:
    ...
    def string_to_tensor(self, text, view=True, device="cpu", handle_missing=True, input_phonemes=False):
        """
...
if __name__ == '__main__':
    ...
    #tf.string_to_tensor("Hi( - Alles klar, jetzt. testen wir einen deutschen Satz... Ich hoffe.. es gibt nicht mehr viele unspezifizierte Phoneme. Unter uns, fuhr!!! fuhr?", view=True)
