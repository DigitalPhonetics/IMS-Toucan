...
class SimilaritySolver:
    def __init__(self,
        ...
        iso_to_fullname_path = hf_hub_download(repo_id="Flux9665/ToucanTTS", filename="iso_to_fullname.json") if not iso_to_fullname_path else iso_to_fullname_path

        if force_reload:
            tree_dist_path = hf_hub_download(repo_id="Flux9665/ToucanTTS", filename="lang_1_to_lang_2_to_tree_dist.json") if not tree_dist_path else tree_dist_path
            self.lang_1_to_lang_2_to_tree_dist = load_json_from_path(tree_dist_path)
            map_dist_path = hf_hub_download(repo_id="Flux9665/ToucanTTS", filename="lang_1_to_lang_2_to_map_dist.json") if not map_dist_path else map_dist_path
            ...
            learned_dist_path = hf_hub_download(repo_id="Flux9665/ToucanTTS", filename="lang_1_to_lang_2_to_learned_dist.json") if not learned_dist_path else tree_dist_path
            ...
            asp_dict_path = hf_hub_download(repo_id="Flux9665/ToucanTTS", filename="asp_dict.pkl") if not asp_dict_path else asp_dict_path
