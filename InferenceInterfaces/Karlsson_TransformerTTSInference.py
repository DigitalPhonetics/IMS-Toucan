...
from InferenceInterfaces.InferenceTransformerTTS import Transformer
...
class Karlsson_TransformerTTSInference(torch.nn.Module):
    ...
    def __init__(self, device="cpu", speaker_embedding=None):
        ...
        self.phone2mel = Transformer(path_to_weights=os.path.join("Models", "TransformerTTS_Karlsson", "best.pt"),
                                     idim=133, odim=80, spk_embed_dim=None, reduction_factor=1).to(torch.device(device))
