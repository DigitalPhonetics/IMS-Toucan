...
print("emovdb")
tts_scorer = TTSScorer(path_to_model=os.path.join(MODELS_DIR, "ToucanTTS_Baseline_EmoVDB", "checkpoint_2024.pt"), static_speaker_embed=True, device=exec_device)
...
tts_scorer.remove_samples_with_highest_loss(100)
