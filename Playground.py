...
def plot_fastspeech_architecture():
    ...
    out = model.inference(text=text, speech=speech, durations=durations, pitch=pitch, energy=energy, spembs=None, use_teacher_forcing=True)
...
def plot_transformertts_architecture():
    ...
    out = model.inference(text=text, speech=speech, spembs=None, use_teacher_forcing=False)
