...
if __name__ == '__main__':
    ...
    if not os.path.exists(os.path.join(PREPROCESSING_DIR, "Yelp", "emotion_prompts_full.pt")):
        ...
        emotion_to_prompts = torch.load(os.path.join(PREPROCESSING_DIR, "Yelp", "emotion_prompts_full.pt"), map_location='cpu')
    ...
    torch.save(emotion_to_prompts_balanced, os.path.join(PREPROCESSING_DIR, "Yelp", "emotion_prompts_balanced_10000.pt"))
