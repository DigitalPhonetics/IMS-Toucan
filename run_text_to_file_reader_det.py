...
from Architectures.ToucanTTS_det.ToucanTTSInterface import ToucanTTSInterface


def read_texts(model_id, sentence, filename, device="cpu", language="eng", speaker_reference=None, faster_vocoder=False):
...
if __name__ == '__main__':
    ...
    the_raven(version="DET_testing300",
              model_id="DET/first_DET_epd_c64_l6_k5_d0.2",
              exec_device=device,
