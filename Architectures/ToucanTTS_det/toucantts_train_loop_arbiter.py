from Architectures.ToucanTTS_det.toucantts_meta_train_loop import train_loop as multi_language_loop
from Architectures.ToucanTTS_det.toucantts_train_loop import train_loop as mono_language_loop
