...
import Architectures.ToucanTTS_det.ConditionalLayerNorm
...
def initialize(model, init):
    ...
    for m in model.modules():
        if isinstance(m, (torch.nn.Embedding,
                          torch.nn.LayerNorm,
                          Architectures.ToucanTTS_det.ConditionalLayerNorm.ConditionalLayerNorm,
                          Architectures.ToucanTTS_det.ConditionalLayerNorm.SequentialWrappableConditionalLayerNorm
                          )):
            m.reset_parameters()
