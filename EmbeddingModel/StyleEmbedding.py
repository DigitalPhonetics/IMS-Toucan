...
from EmbeddingModel.GST import GSTStyleEncoder
from EmbeddingModel.StyleTTSEncoder import StyleEncoder as StyleTTSEncoder
...
class StyleEmbedding(torch.nn.Module):
    ...
    def __init__(self, embedding_dim=64, style_tts_encoder=False):
        super().__init__()
